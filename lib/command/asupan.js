...
return client.sendImage(msg.from, botinfo.linkApi.zacros+ "/asupan/indonesia/")
});

cmd.on('cewevietnam',['vietnam'],['asupan'],async(msg,{client})=> {
return client.sendImage(msg.from, botinfo.linkApi.zacros+ "/asupan/vietnam/")
});

cmd.on('cewemalaysia',['malaysia'],['asupan'],async(msg,{client})=> {
return client.sendImage(msg.from, botinfo.linkApi.zacros+ "/asupan/malaysia/")
});
...
return client.sendImage(msg.from, botinfo.linkApi.zacros+ "/asupan/thailand/")
});
