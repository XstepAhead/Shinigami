...
cmd.on("ssweb",["ss","ssweb"],["tools"],async(msg,{query,client})=>{
return client.sendImage(msg.from, botinfo.linkApi.zacros+"/tools/ssweb?link="+query)
 },{param:functions.needed("link"),query:"Masukan Linknya!\nEx : .ssweb " + botinfo.linkApi.zacros});
