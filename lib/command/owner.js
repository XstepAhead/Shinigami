...
return client.reply(msg,functions.util.format(evaluate), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'https://instagram.com/abidnovember'}}});
} catch(e){
return res.client.reply(msg,functions.util.format(e), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'https://instagram.com/abidnovember'}}});
}
...
if (err) return client.reply(msg,functions.util.format(err), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'https://instagram.com/abidnovember'}}});
client.reply(msg,functions.util.format(out), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'https://instagram.com/abidnovember'}}});
});
} catch(e){
 return res.client.reply(msg,functions.util.format(e), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'https://instagram.com/abidnovember'}}});
}
...
for (let _ of anu) {
client.sendText(_, `${query}\n\n${botinfo.botname} All Group Broadcast\n  Sender : ${sender}`)}
},{owner:'Only owner',query:'Isi query!'});
